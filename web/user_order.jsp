    ...
    <div class="container-fluid">
        ...
        <div>
            <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="user_order.jsp">我的预订</a></li>
            </ul>
        </div>
    ...
    try
    {
        ...
        %>
            <tr>
                ...
                <td>
                    <form action="userdelete" method="post" onsubmit="return confirm('确定要取消吗？');">
                    ...
                    <%
                        ...
                        {
                    %>
                    <form action="user_order_change.jsp" method="post">
                        <input type="text" style="display:none"  value=<%=result.getString("order_id")%> name="order_id"/>
                        <input type="submit" value="修改本次预订" class="btn btn-primary">
                    </form>
                    <%
                        }
                    %>
