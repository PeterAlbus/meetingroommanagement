    ...
    <div class="container-fluid">
        ...
        <div>
            <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="admin_room.jsp">管理会议室</a></li>
                <%
                    if(groupid==3)
                    {
                %>
        ...
        <div class="col-md-6">
            ...
            <form action="addroom" method="post">
                <div class="form-group">
                    ...
                    <p class="text-left"><label for="room_name">会议室类型：</label><input type="text" name="room_name" class="form-control" id="room_name" placeholder="输入会议室类型"/></p>
                </div>
...
<%
    try
    {
        ...
        ps=conn.prepareStatement("select * from meetingroommanagement.meetingrooms");
        result=ps.executeQuery();
        while(result.next())
        {
        %>
