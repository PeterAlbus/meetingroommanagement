...
public class canceladmin extends HttpServlet
{
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
    {
        ...
        String needadmin=request.getParameter("username");
        try
        {
            ...
            PreparedStatement ps=conn.prepareStatement("update meetingroommanagement.users set users.groupid = 1 where username=?");
            ps.setString(1,needadmin);
            ps.executeUpdate();
            ps.close();
            conn.close();
